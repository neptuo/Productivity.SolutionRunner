    ...
    internal partial class AppTrayIcon
    {
        ...
        public bool TryCreate()
        {
            if (settings.IsTrayIcon && trayIcon == null)
            {
                ...
                trayIcon.ContextMenuStrip.Items.Add("Open").Click += (sender, e) => { navigator.OpenMain(); windows.Configuration?.Close(); windows.Statistics?.Close(); };
                trayIcon.ContextMenuStrip.Items.Add("Configuration").Click += (sender, e) => { navigator.OpenConfiguration(); windows.Main?.Close(); windows.Statistics?.Close(); };
                trayIcon.ContextMenuStrip.Items.Add("Statistics").Click += (sender, e) => navigator.OpenStatistics();
